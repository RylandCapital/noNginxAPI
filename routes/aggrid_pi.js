...
router.route('/tickers/diversifiedconsumerservices').get((req, res) => {aggrid_pib['diversifiedconsumerservices'].find().lean().then(aggrid_pi =>res.json(aggrid_pi)).catch(err => res.status(400).json('Error: ' + err));});
